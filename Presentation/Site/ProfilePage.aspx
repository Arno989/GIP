...
<div class="login-page">
  ...
  <form runat="server" class="form">
    <div class="edit-form">
      ...
      <asp:TextBox runat="server" ID="tbAccountType" ReadOnly="true" CssClass="input"></asp:TextBox>
      <asp:TextBox runat="server" ID="tbPasswordOld" AutoCompleteType="None" placeholder="old password (optional)" TextMode="Password" CssClass="input" OnTextChanged="tb_TextChanged"></asp:TextBox>
      <asp:TextBox runat="server" ID="tbPasswordNew1" placeholder="new password (optional)" TextMode="Password" CssClass="input" OnTextChanged="tb_TextChanged"></asp:TextBox>
        <asp:Label runat="server" ID="lbErrorPassword" Visible="false" CssClass="error"></asp:Label>
      <asp:TextBox runat="server" ID="tbPasswordNew2" placeholder="new password (optional)" TextMode="Password" CssClass="input" OnTextChanged="tb_TextChanged"></asp:TextBox>        
