    ...
    public partial class StudyCoordinatorPageEdit : System.Web.UI.Page
    {
        ...
        private void SendData()
        {
            for (int i = 0; i < 10; i++)
            {
                ...
                _business.AddStudyCoordinator(new StudyCoordinatorCode(0, input[0], input[1], input[2], input[3], input[4], input[5], user.ID, Convert.ToDateTime(dateNow), Convert.ToDateTime(dateNow))); //--Var
