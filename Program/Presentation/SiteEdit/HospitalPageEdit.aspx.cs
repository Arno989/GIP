	...
	public partial class HospitalPageEdit: System.Web.UI.Page
	{
        ...
        private void UpdateData()
        {
            ...
            for (int i = 0; i < ListDataIDs.Count; i++)
            {
                ...
                _business.UpdateHospital(new HospitalCode(ListDataIDs[i], input[0], input[1], input[2], input[3], input[4], input[5], user.ID, Convert.ToDateTime(dateNow), Convert.ToDateTime(dateNow))); //--Var
                track1:
                continue;
            }
        }
