	...
	public partial class HospitalPageEdit: System.Web.UI.Page
	{
        ...
        private void SendData()
        {
            for (int i = 0; i < 10; i++)
            {
                ...
                _business.AddHospital(input[0], input[1], input[2], input[3], input[4], input[5], user.ID.ToString(), dateNow, dateNow); //--Var
                track1:
                continue;
            }
        }
        ...
        private void UpdateData()
        {
            ...
            for (int i = 0; i < ListDataIDs.Count; i++)
            {
                ...
                _business.UpdateHospital(ListDataIDs[i], input[0], input[1], input[2], input[3], input[4], input[5], user.ID.ToString(), dateNow); //--Var
                track1:
                continue;
            }
        }
