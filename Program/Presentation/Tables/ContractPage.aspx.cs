	...
	public partial class ContractPage: System.Web.UI.Page
	{
        ...
        protected void Gridview_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                for (int i = 1; i < GridView.Columns.Count; i++)
                {
                    if (user.Type == "Admin")
                    {
                        UserCode _user = _businesscode.GetUsers($"WHERE User_ID = {_contract[0].UserID};")[0];
        ...
        public void FillProject()
        {
            for (int i = 0; i < GridView.Rows.Count; i++)
            {
                ...
                GridView.Rows[i].Cells[4].Text = ProjectTitle;
            }
        }
        ...
        public void FillClient()
        {
            for (int i = 0; i < GridView.Rows.Count; i++)
            {
                ...
                GridView.Rows[i].Cells[5].Text = ClientName;
            }
        }
    }
}