<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.0.Master" AutoEventWireup="true" CodeBehind="AdministratorPage.aspx.cs" Inherits="Presentation.Site.AdministratorPage" %>
                     ...
                     <div class="login-page">
                        <div class="edit">
                            <div class="form">
                                ...
                                <asp:Label runat="server" ID="lbErrorUsername" Visible="false" CssClass="error"></asp:Label>
                                <asp:TextBox runat="server" ID="tbEmail" placeholder="email adress" CssClass="input" OnTextChanged="Tb_TextChanged"></asp:TextBox>
                                <asp:Label runat="server" ID="lbErrorEmail" Visible="false" CssClass="error"></asp:Label>
